...
it('PUT should update a cat', async () => {
  ...
  console.log(cats2);
  const updatedCat = {color: 'mane-y', flavor: 'lion'}
  console.log(updatedCat);

  const removedStriped = cats2.pop()
  console.log(removedStriped);

  cats2.push(updatedCat);

  expect(cats2).toEqual([
    { color: 'green', flavor: 'huh' },
    { color: 'yellow', flavor: 'sunny' },
    { color: 'mane-y', flavor: 'lion' }
  ]
  );
});
